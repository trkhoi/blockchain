...
func (_Main *MainTransactor) CreateToken(opts *bind.TransactOpts, tokenURI string) (*types.Transaction, error) {
	return _Main.contract.Transact(opts, "createToken", tokenURI)
}

// CreateToken is a paid mutator transaction binding the contract method 0x45576f94.
//
// Solidity: function createToken(string tokenURI) returns(uint256)
func (_Main *MainSession) CreateToken(tokenURI string) (*types.Transaction, error) {
	return _Main.Contract.CreateToken(&_Main.TransactOpts, tokenURI)
}

// CreateToken is a paid mutator transaction binding the contract method 0x45576f94.
//
// Solidity: function createToken(string tokenURI) returns(uint256)
func (_Main *MainTransactorSession) CreateToken(tokenURI string) (*types.Transaction, error) {
	return _Main.Contract.CreateToken(&_Main.TransactOpts, tokenURI)
}
